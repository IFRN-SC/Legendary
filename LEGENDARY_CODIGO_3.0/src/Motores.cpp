...
#define DIR_POSITIVO_GIRO_CURVA 23
#define DIR_NEGATIVO_GIRO_CURVA -25
#define ESQ_POSITIVO_GIRO_CURVA (DIR_POSITIVO_GIRO_CURVA + DIFERENCA)
#define ESQ_NEGATIVO_GIRO_CURVA (DIR_NEGATIVO_GIRO_CURVA - DIFERENCA)
...
#define DIR_NEGATIVO_FRENTE_CURVA -25
...
//Movimentos Curva
void Motores::giroCurvaEsq(){robo.acionarMotores(ESQ_NEGATIVO_GIRO_CURVA, DIR_POSITIVO_GIRO_CURVA);}
void Motores::giroCurvaDir(){robo.acionarMotores(ESQ_POSITIVO_GIRO_CURVA, DIR_NEGATIVO_GIRO_CURVA);}
